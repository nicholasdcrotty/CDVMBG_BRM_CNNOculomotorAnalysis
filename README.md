...
This repository contains the scripts for a CNN-based analysis of time-course oculomotor data, as described in Crotty, Doyle, Volkova, Massa, Benson, &amp; Grubb (resubmitted).
...
## Data
As mentioned earlier, all of the relevant data for this project is available [here](https://doi.org/10.5281/zenodo.19489022), in a folder called **``dataForDownload``**. Here is what each file contains:
