...
1. Taking a subset of the input that includes a given feature and finding the model's output for that subset (the "explainer model")
2. Find the model's output for the same subset but with the given feature removed 
