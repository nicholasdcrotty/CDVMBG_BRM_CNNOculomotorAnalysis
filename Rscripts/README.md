...
This `.csv` file contains the diagnostic information (mean, standard deviation, 95% credible interval, r-hat, and number of effective samples) for all Bayesian models reported in the manuscript.
