...
print(c("Overall accuracy (%): ", means$all*100))
print(c("Mean across subjects (%): ", meansSubj$all*100))
print(c("bootstrapped subject-level 95% CI (%): ", rev(as.vector(errorsSubj$all))*100))
print("t-test comparing to chance: ")
t.test(magSortAll$acc*100, chance[1:72]*100, paired = TRUE)

print("CNN predicting target location from Grubb & Li (2018) data")
print(c("Overall accuracy (%): ", means_GL$targLoc*100))
print(c("Mean across subjects (%): ", meansSubj_GL$targLoc*100))
print(c("bootstrapped subject-level 95% CI (%): ", rev(as.vector(errorsSubj_GL$targLoc)*100)))
print("t-test comparing to chance: ")
t.test(magSortTargLoc$acc*100, chance[1:97]*100, paired = TRUE)

print("CNN predicting distractor location from Massa et al. (2024) data")
print(c("Overall accuracy (%): ", means$valueDist*100))
print(c("Mean across subjects (%): ", meansSubj$valueDist*100))
print(c("bootstrapped subject-level 95% CI (%): ", rev(as.vector(errorsSubj$valueDist))*100))
print("t-test comparing to chance: ")
t.test(magSortVal$acc*100, chance[1:72]*100, paired = TRUE)

print("CNN predicting distractor location from Grubb & Li (2018) data")
print(c("Overall accuracy (%): ", means_GL$distLoc*100))
print(c("Mean across subjects (%): ", meansSubj_GL$distLoc*100))
print(c("bootstrapped subject-level 95% CI (%): ", rev(as.vector(errorsSubj_GL$distLoc))*100))
print("t-test comparing to chance: ")
t.test(magSortDistLoc$acc*100, chance[1:97]*100, paired = TRUE)

print("CNN trained on Massa et al. (2024) data and predicting distractor location from Doyle et al. (2025) data")
print(c("Overall accuracy (%): ", means_Doyle$transfer*100))
print(c("Mean across subjects (%): ", meansSubj_Doyle$transfer*100))
print(c("bootstrapped subject-level 95% CI (%): ", rev(as.vector(errorsSubj_Doyle$transfer))*100))
print("t-test comparing to chance: ")
t.test(magSortTransfer$acc*100, chance*100, paired = TRUE)
